...
class PharmaceuticalType(models.Model):
	name = models.CharField(max_length=500, blank=False, null=True, default="Default")
...
class PharmaceuticalCategory(models.Model):
...
class Pharmaceuticals(models.Model):
	...
	# product_name = models.CharField(max_length=10000, blank=False, null=False)
	...
	product_category = models.ForeignKey(PharmaceuticalCategory, on_delete=models.CASCADE, related_name='drug_cat')
	quantity_available = models.IntegerField(verbose_name='quantity available', default=0)
	product_measurement = models.CharField(max_length=500, blank=True, null=True)
	...
	product_type = models.ForeignKey(PharmaceuticalType, on_delete=models.CASCADE, related_name='drug_type')
	ordered_date = models.DateTimeField(auto_now_add=True)
	...
	def class_of_low_and_empty(self):
		if self.quantity_available <= 0:
			return "badge-danger"
		elif self.quantity_available <= self.reorder_level:
...
class Procurement(models.Model):
	product = models.ForeignKey(Pharmaceuticals, on_delete=models.CASCADE, related_name='product_ordered')
	purchase_ref = models.CharField(max_length=500, blank=True, null=True, default=random_string)
	expiry_date = models.DateField(null=True, blank=True)
	date = models.DateField(auto_now_add=True)
	quantity_ordered = models.IntegerField(verbose_name='quantity ordered', blank=False, null=True)
...
class ProcurementList(models.Model):
	product = models.ForeignKey(Pharmaceuticals, on_delete=models.CASCADE, related_name='procurement')
	product_name = models.TextField(blank=True, null=True)
	price = models.IntegerField(default=0)
	purchase_ref = models.CharField(max_length=500, blank=True, null=True, default=random_string)
	supplier = models.CharField(max_length=500, blank=True, null=True)
	quantity_ordered = models.IntegerField(verbose_name='quantity ordered', blank=True, null=True)
	total = models.IntegerField(help_text='total = price * quantity_ordered', blank=True, null=True)
	date = models.DateField(auto_now_add=True)
	expiry_date = models.DateField(null=True, blank=True)
	ordered_date = models.DateTimeField(auto_now_add=True)
	...
	def __str__(self):
		return self.product.product_name + " " + str(self.quantity_ordered) + " " + self.indicate_product_has_expired_already
...
class SalesList(models.Model):
	...
	product_name = models.TextField(blank=True, null=True)
	price = models.IntegerField(default=0)
	sales_ref = models.CharField(max_length=500, blank=True, null=True, default=random_string)
	customer = models.CharField(max_length=500, blank=True, null=True)
	sales_type = models.CharField(max_length=500, choices=SALES_TYPE, blank=True, null=True, default='Retail')
	quantity_sold = models.IntegerField(verbose_name='quantity sold', blank=True, null=True)
	total = models.IntegerField(help_text='total = price * quantity_ordered', blank=True, null=True)
	date = models.DateField(auto_now_add=True)
	ordered_date = models.DateTimeField(auto_now_add=True)
...
class Transactions(models.Model):
	...
	amount_received = models.IntegerField(verbose_name='amount received', default=0)
	amount_tendered = models.IntegerField(verbose_name='amount tendered', default=0)
...
class Sales(models.Model):
	product = models.ForeignKey(ProcurementList, on_delete=models.CASCADE, related_name='product_sold')
