...
class Products(models.Model):
	...
	custom_id = models.CharField(max_length=50, blank=True, null=True, default=random_string)
	product_category = models.ForeignKey(ProductCategory, on_delete=models.CASCADE, related_name='product_cat')
	quantity_available = models.IntegerField(verbose_name='quantity available', default=0)
	product_measurement = models.CharField(max_length=10, blank=True, null=True)
...
class Procurement(models.Model):
	product = models.ForeignKey(Products, on_delete=models.CASCADE, related_name='my_product_ordered')
...
class ProcurementList(models.Model):
	product = models.ForeignKey(Products, on_delete=models.CASCADE, related_name='procurement')
...
class SalesList(models.Model):
	...
	sales_type = models.CharField(max_length=9, choices=SALES_TYPE, blank=True, null=True, default='Retail')
	quantity_sold = models.IntegerField(verbose_name='quantity sold', blank=True, null=True)
	total = models.IntegerField(help_text='total = price * quantity_sold', blank=True, null=True)
	date = models.DateField(auto_now_add=True)
	ordered_date = models.DateTimeField(auto_now_add=True)
